    ...
    class Program
    {
        static void Main(string[] args)
        {
            if (args.Length != 3)
            {
                ...
                Console.WriteLine(@"Exemplo: ZoomInterpolacao.exe c:\img.jpg 2 c:\img_ampliada.jpg");
            ...
            else
            {
                ...
                try
                {
                    ...
                    for (var i = 0; i < zoomedImage.Width; i++)
                    {
                        ...
                        {
                            zoomedImage.SetPixel(i, j, System.Drawing.Color.Black);
                        }
                    }
                    ...
                    for (decimal i = 0; i < width; i++)
                    {
                        for (decimal j = 0; j < heigth; j++)
                        {
                            ...
                            {
                                //Não posso calcular um pixel da imagem original
                            }
                            else
                            {
